...
from ..evaluate.evaluate import compute_edit_quality, compute_icl_edit_quality
...
class BaseEditor:
    ...
    def edit(self,
             ...
             n_to_n_knowledge_inputs: Optional[Dict] = None,
    ...
    def _prepare_requests(self,
        ...
        if 'demonstrated_prompts' in kwargs and kwargs['demonstrated_prompts'] != None and len(kwargs['demonstrated_prompts']) > 0:
            if isinstance(kwargs['demonstrated_prompts'], str):
                kwargs['demonstrated_prompts'] = [kwargs['demonstrated_prompts'],]
            else:
                assert len(kwargs['demonstrated_prompts']) == len(prompts)
            
            for i, request in enumerate(requests):
                request.update(
                    {
                        'demonstrated_prompt': kwargs['demonstrated_prompts'][i]
                    }
                )
